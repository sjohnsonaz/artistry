            ...
            <Section header="Card" space headerSpace>
                    ...
                    <Fillable card filled={this.state.filled}>
                        <Card grid space fill>
                            <Row>
                                ...
                                <Cell>
                                    <Button onClick={this.toggleClosed}>
                                        Expand
                                    </Button>
                                    <Button onClick={this.toggleFilled}>
                                        Fill
                                    </Button>
                                </Cell>
                            </Row>
                ...
                <div>
                    ...
                    <CardCarousel activeIndex={this.state.index}>
                        <Card type="success" handle="left" square>
                            <CardSection multiColumn>
                                <CardControl title="Title 1">
                                    Data 1
                                </CardControl>
                                <CardControl title="Title 2">
                                    Data 2
                                </CardControl>
                                <CardControl title="Title 3">
                                    Data 3
                                </CardControl>
                                <CardControl title="Title 4">
                                    Data 4
                                </CardControl>
                            </CardSection>
                        </Card>
