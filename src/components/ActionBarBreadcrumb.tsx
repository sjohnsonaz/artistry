...
export default class ActionBarBreadcrumb extends React.Component<
    IActionBarBreadcrumbProps,
    IActionBarBreadcrumbState
> {
    ref: React.RefObject<HTMLDivElement> = React.createRef();
    state: IActionBarBreadcrumbState = {};

    componentDidMount() {
        const breadcrumbHeader = this.ref.current;
        if (breadcrumbHeader) {
    ...
    render() {
        ...
        return (
            <div ref={this.ref} className={classNames.toString()} id={id}>
                {observer
                    ? React.Children.map(
                          this.props.children,
                          (child, index) => {
...
export class ActionBarItem extends React.Component<
    IActionBarItemProps,
    IActionBarItemState
> {
    ref: React.RefObject<HTMLDivElement> = React.createRef();
