...
export interface IMaskedInputProps<T>
...
export default class MaskedInput<T> extends React.Component<
    IMaskedInputProps<T>,
    any
> {
    ...
    constructor(props: IMaskedInputProps<T>) {
        super(props);
    ...
    updateElement(maskUpdate: IMaskUpdate) {
        ...
        if (input) {
            ...
            if (
                typeof maskUpdate.selectionEnd !== 'undefined' &&
                typeof maskUpdate.selectionEnd !== 'undefined'
            ) {
                input.setSelectionRange(
                    // @ts-expect-error
                    maskUpdate.selectionStart,
                    maskUpdate.selectionEnd,
                    'none'
                );
    ...
    onFocus = (event: React.FocusEvent<HTMLInputElement>) => {
        ...
        this.updateElement(
            this.mask.updateSelection(event.target.value, this.getSelection())
        );
    };
    ...
    render() {
        let { id, className, value, fill, onChange, ...props } = this.props;
